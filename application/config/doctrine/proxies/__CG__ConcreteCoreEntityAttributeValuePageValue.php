 ...
 */
class PageValue extends \Concrete\Core\Entity\Attribute\Value\PageValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageValue $proxy) {
    ...
    public function getVersionID()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVersionID', []);
    ...
    public function setVersionID($cvID)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVersionID', [$cvID]);

        return parent::setVersionID($cvID);
    }
