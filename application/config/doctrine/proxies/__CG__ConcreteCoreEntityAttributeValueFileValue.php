 ...
 */
class FileValue extends \Concrete\Core\Entity\Attribute\Value\FileValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'fID', 'fvID', 'attribute_key', 'generic_value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FileValue $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setVersion(\Concrete\Core\Entity\File\Version $version)
    {
