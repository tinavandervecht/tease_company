 ...
 */
class SiteValue extends \Concrete\Core\Entity\Attribute\Value\SiteValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'site', 'attribute_key', 'generic_value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SiteValue $proxy) {
