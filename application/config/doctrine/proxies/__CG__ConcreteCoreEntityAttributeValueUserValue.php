 ...
 */
class UserValue extends \Concrete\Core\Entity\Attribute\Value\UserValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserValue $proxy) {
